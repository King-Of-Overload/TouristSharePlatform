...
<div class="section section_bg list mt">
      <div class="list_tit"><div class="list_titl"></div><h1 class="tit_style1"><s:property value="tagTitle"/></h1><div class="list_titr"></div></div>
      
        <dl class="list_news">
        <s:iterator value="allArticles" var="at">
        <dt>
        <span class="date"><s:date name="#at.skilldate" format="yyyy-MM-dd"/></span>
        <h3><a href="${pageContext.request.contextPath}/skillacademy_goToShowOneSkillAcademyArticle.go?skillId=<s:property value='#at.skilid'/>"><s:property value='#at.skilltitle'/></a></h3></dt>
			<dd class="clearfix">
			<a href="${pageContext.request.contextPath}/skillacademy_goToShowOneSkillAcademyArticle.go?skillId=<s:property value='#at.skilid'/>">
			<img src="<s:property value='#at.coverImage'/>" width="160px" height="107px" alt="<s:property value='#at.skilltitle'/>"></a>
			<p><s:property value='#at.skillplaintext.substring(0,200)'/>…………<a class="more" href="${pageContext.request.contextPath}/skillacademy_goToShowOneSkillAcademyArticle.go?skillId=<s:property value='#at.skilid'/>"><br>查看全文&gt;&gt; </a></p>
			</dd>
			</s:iterator>
			</dl>       
...
<div class="content-right">
      ...
      <div class="hot_tags clearfix">
      	<div id="tagscloud">
							<!-- TODO: -->
							<s:iterator value="secondTags" var="st">
							<a
								href="${pageContext.request.contextPath}/skillacademy_clickRelatedTagToSkillAcademyList.go?secondTagId=<s:property value='#st.hotTagId'/>"
								class="<s:property value='#st.randomClassName'/>"
								title="<s:property value='#st.tagName'/>"><s:property value='#st.tagName'/></a>
								</s:iterator>
					</div>
        </div>
    </div>
    ...
    <a href="${pageContext.request.contextPath}/skillacademy_goToShowOneSkillAcademyArticle.go?skillId=<s:property value='#ha.skillId'/>" title="<s:property value='#ha.skilltitle'/>" class="pic">
    <img src='<s:property value='#ha.coverImage'/>' alt="<s:property value='#ha.skilltitle'/>" title="<s:property value='#ha.skilltitle'/>" width="120" height="90">
    </a>
    </div>
    <a href="${pageContext.request.contextPath}/skillacademy_goToShowOneSkillAcademyArticle.go?skillId=<s:property value='#ha.skillId'/>" title="<s:property value='#ha.skilltitle'/>"><s:property value='#ha.skilltitle'/></a>
    </li>
    </s:iterator>
    </ul>
    </div>
